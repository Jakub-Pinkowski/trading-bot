...
from app.services.orders import (place_order, invalidate_cache, get_contract_position,
...
@patch('app.services.orders.api_post')
...
@patch('app.services.orders.invalidate_cache')
@patch('app.services.orders.api_get')
