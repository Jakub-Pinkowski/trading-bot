...
from app.services.ibkr.orders import (place_order, invalidate_cache, get_contract_position,
...
@patch('app.services.ibkr.orders.invalidate_cache')
@patch('app.services.ibkr.orders.api_get')
