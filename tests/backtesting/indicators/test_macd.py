...
def test_calculate_macd_with_custom_parameters():
    ...
    prices_hash = hash_series(prices)
    macd = calculate_macd(prices, fast_period=5, slow_period=10, signal_period=3, prices_hash=prices_hash)
...
def test_calculate_macd_parameter_sensitivity():
    ...
    prices_hash = hash_series(prices)
    macd_default = calculate_macd(prices, fast_period=12, slow_period=26, signal_period=9, prices_hash=prices_hash)

    # Calculate MACD with faster response parameters
    prices_hash = hash_series(prices)
    macd_fast = calculate_macd(prices, fast_period=6, slow_period=13, signal_period=4, prices_hash=prices_hash)

    # Calculate MACD with slower response parameters
    prices_hash = hash_series(prices)
    macd_slow = calculate_macd(prices, fast_period=24, slow_period=52, signal_period=18, prices_hash=prices_hash)
