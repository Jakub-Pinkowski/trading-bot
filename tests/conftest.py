...
def mock_logger_connection(monkeypatch):
    logger = MagicMock()
    monkeypatch.setattr('app.services.connection.logger', logger)
    return logger
...
def mock_api_post_connection(monkeypatch):
    api_post = MagicMock()
    monkeypatch.setattr('app.services.connection.api_post', api_post)
    return api_post
...
def mock_scheduler(monkeypatch):
    scheduler = MagicMock()
    monkeypatch.setattr('app.services.connection.scheduler', scheduler)
    return scheduler
...
def mock_logger_contracts(monkeypatch):
    logger = MagicMock()
    monkeypatch.setattr('app.services.contracts.logger', logger)
    return logger
...
def mock_load_file(monkeypatch):
    mock = MagicMock()
    monkeypatch.setattr('app.services.contracts.load_file', mock)
    return mock
...
def mock_save_file(monkeypatch):
    mock = MagicMock()
    monkeypatch.setattr('app.services.contracts.save_file', mock)
    return mock
...
def mock_parse_symbol(monkeypatch):
    mock = MagicMock()
    monkeypatch.setattr('app.services.contracts.parse_symbol', mock)
    return mock
...
def mock_fetch_contract(monkeypatch):
    mock = MagicMock()
    monkeypatch.setattr('app.services.contracts.fetch_contract', mock)
    return mock
...
def mock_get_closest_contract(monkeypatch):
    mock = MagicMock()
    monkeypatch.setattr("app.services.contracts.get_closest_contract", mock)
    return mock
...
def mock_get_contract_position(monkeypatch):
    mock = MagicMock()
    monkeypatch.setattr("app.services.orders.get_contract_position", mock)
    return mock
...
def mock_api_post_orders(monkeypatch):
    mock = MagicMock()
    monkeypatch.setattr("app.services.orders.api_post", mock)
    return mock
...
def mock_logger_orders(monkeypatch):
    mock = MagicMock()
    monkeypatch.setattr("app.services.orders.logger", mock)
    return mock
...
def mock_suppress_messages(monkeypatch):
    mock = MagicMock()
    monkeypatch.setattr("app.services.orders.suppress_messages", mock)
    return mock
