...
class TestProcessTradingData:
    ...
    def test_normal_buy_places_order(
        self, mock_logger_trading, mock_place_order, mock_contract_resolver
    ):
        """Test buy order is placed and success is logged."""
        mock_contract_resolver.get_front_month_conid.return_value = '123456'
        ...
        mock_contract_resolver._class.assert_called_once_with('ZC')
        mock_contract_resolver.get_front_month_conid.assert_called_once_with()
    ...
    def test_dummy_mode_skips_order(
        ...
        mock_contract_resolver._class.assert_not_called()
    ...
    def test_contract_id_exception_propagates(
        ...
        """Test ValueError from get_front_month_conid propagates out of process_trading_data."""
        mock_contract_resolver.get_front_month_conid.side_effect = ValueError('Test error')
        trading_data = {'dummy': 'NO', 'symbol': 'ZC', 'side': 'B', 'price': '4500.00'}
