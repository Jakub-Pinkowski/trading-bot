...
Public API:
- SYMBOL_SPECS: Complete symbol specifications dictionary
- TV_TO_IBKR_MAPPING: TradingView to IBKR symbol mapping
- IBKR_TO_TV_MAPPING: IBKR to TradingView symbol mapping
- Category lists: GRAINS, SOFTS, ENERGY, METALS, CRYPTO, INDEX, FOREX
- Helper functions: get_exchange_for_symbol, get_category_for_symbol, etc.
- Mapping functions: map_tv_to_ibkr, map_ibkr_to_tv
"""
