...
SYMBOL_SPECS = {
    ...
    # --- Metals - Micro ---
    'MGC': {'category': 'Metals', 'exchange': 'COMEX_MINI', 'multiplier': 10, 'tick_size': 0.10, 'margin': 3760.60},
    # Micro Gold
    'SIL': {'category': 'Metals', 'exchange': 'COMEX_MINI', 'multiplier': 1000, 'tick_size': 0.005, 'margin': 14892.19},
    # Micro Silver (TradingView symbol, maps to QI in IBKR)
    'MHG': {'category': 'Metals', 'exchange': 'COMEX_MINI', 'multiplier': 2500, 'tick_size': 0.0005, 'margin': 1878.61},
    # Micro Copper
    ...
    # --- Index - Normal ---
    'ES': {'category': 'Index', 'exchange': 'CME_MINI', 'multiplier': 50, 'tick_size': 0.25, 'margin': 23102.20},
    # E-mini S&P 500
    'NQ': {'category': 'Index', 'exchange': 'CME_MINI', 'multiplier': 20, 'tick_size': 0.25, 'margin': 35512.40},
    # E-mini NASDAQ-100
    'YM': {'category': 'Index', 'exchange': 'CBOT', 'multiplier': 5, 'tick_size': 1.00, 'margin': 15758.45},
    # E-mini Dow
    'RTY': {'category': 'Index', 'exchange': 'CME_MINI', 'multiplier': 50, 'tick_size': 0.10, 'margin': 10462.70},
    # E-mini Russell 2000
    'ZB': {'category': 'Index', 'exchange': 'CBOT', 'multiplier': 114, 'tick_size': 0.03125, 'margin': 4255},
    # 30-Year T-Bond

    # --- Index - Micro ---
    'MES': {'category': 'Index', 'exchange': 'CME_MINI', 'multiplier': 5, 'tick_size': 0.25, 'margin': 2310},
    # Micro E-mini S&P 500
    'MNQ': {'category': 'Index', 'exchange': 'CME_MINI', 'multiplier': 2, 'tick_size': 0.25, 'margin': 3550.80},
    # Micro E-mini NASDAQ-100
    'MYM': {'category': 'Index', 'exchange': 'CBOT', 'multiplier': 0.5, 'tick_size': 1.00, 'margin': 1575.50},
    # Micro E-mini Dow
    'M2K': {'category': 'Index', 'exchange': 'CME_MINI', 'multiplier': 5, 'tick_size': 0.10, 'margin': 1046.50},
    ...
    # --- Forex - Micro ---
    'M6E': {'category': 'Forex', 'exchange': 'CME_MINI', 'multiplier': None, 'tick_size': None, 'margin': 343.53},
    # Micro Euro FX
    'M6A': {'category': 'Forex', 'exchange': 'CME_MINI', 'multiplier': None, 'tick_size': None, 'margin': 234.458},
    # Micro Australian Dollar
    'M6B': {'category': 'Forex', 'exchange': 'CME_MINI', 'multiplier': None, 'tick_size': None, 'margin': 252.064},
    # Micro British Pound
}
