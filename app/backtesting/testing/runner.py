...
def run_single_test(test_params):
    ...
    cache_stats = {
        'ind_hits': indicator_cache.hits - ind_hits_before,
        'ind_misses': indicator_cache.misses - ind_misses_before,
        'df_hits': dataframe_cache.hits - df_hits_before,
        'df_misses': dataframe_cache.misses - df_misses_before,
    }
