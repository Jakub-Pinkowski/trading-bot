...
def _format_column_name(column_name):
    """
    Convert snake_case column names to human-readable Title Case format (internal use only).
    ...
    column_name_mapping = {
        ...
        'largest_win_percentage_of_contract': 'largest_win_%',
        'largest_loss_percentage_of_contract': 'largest_loss_%',
