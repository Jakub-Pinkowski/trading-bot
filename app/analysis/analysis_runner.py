...
from app.utils.analysis_utils.analysis_utils import match_trades, alerts_match_trades
...
def run_analysis():
    ...
    alerts_matched_trades = alerts_match_trades(tw_alerts)

    # Per trades metrics
    trades_with_per_trade_metrics = add_per_trade_metrics(matched_trades)
    alerts_with_per_trade_metrics = add_per_trade_metrics(alerts_matched_trades)
